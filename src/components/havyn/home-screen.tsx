...
export function HomeScreen({ user, onSignOut }: { user: any, onSignOut: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full bg-gradient-to-br from-green-50 to-emerald-100/50 dark:from-zinc-900 dark:to-zinc-800">
      <div className="relative">
        {/* The Live Depiction Button */}
        <motion.button 
          onClick={() => setMenuOpen(true)}
          className="relative flex items-center justify-center w-32 h-32 rounded-full hover:bg-white/10 transition-colors"
      ...
      {/* Decorative text telling user they can swipe */}
      <div className="absolute bottom-12 text-zinc-400 text-xs font-medium tracking-widest uppercase flex gap-8 opacity-70">
        <span>← Calendar</span>
        <span>Swipe</span>
        <span>Journal →</span>
      </div>
